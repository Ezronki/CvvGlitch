                        ...
                        CONTACT US
                            ...
                            <p className='flex justify-center items-center'>
                                ...
                                <span className="ml-2 text-[#00ff00] font-extrabold ">
                                    <a href="mailto:hublogs3@gmail.com">CLICK HERE</a>
                                </span>
                            </p>
                            ...
                            <p className='flex justify-center items-center '>
                                ...
                                <a href="https://t.me/Track4Admin1" className="text-white font-bold ml-2">
                                    @Track4Admin1
                                </a>
                                <span className="text-[#00ff00] font-extrabold ml-2 ">
                                    <a href="https://t.me/track4admin1">CLICK HERE</a>
                                </span>
                            </p>
                            <p className='flex justify-center items-center '>
