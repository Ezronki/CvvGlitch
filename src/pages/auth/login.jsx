...
const AuthLogin = () => {
  ...
  return (
    <motion.div
      className="h-screen w-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.6 }}
    >
      <div className="w-full max-w-md bg-gray-800/90 backdrop-blur-lg rounded-xl p-8 border border-gray-700 shadow-2xl">
        <motion.div
